...
const products = [
  {
    id: 1,
    name: "VNS Epilepsia",
    image: "/images/imgs-prods/neurofuncional-vns-epilepsia/vns-epilepsia.png",
    description: "Sistema de estimulação do nervo vago para tratamento adjuvante de epilepsia refratária.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/tratamento.pdf" }
    ]
  }
]

export default function VNSEpilepsia() {
  return (
    <>
      <Header />
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            <div className="max-w-3xl">
              ...
              <p className="text-lg lg:text-xl text-white/90 leading-relaxed">
                Terapia de Estimulação do Nervo Vago (VNS) para epilepsia refratária. 
                Sistema comprovado clinicamente para redução de crises convulsivas e 
                melhoria da qualidade de vida em pacientes com epilepsia não controlada 
                por medicamentos.
              </p>
            </div>
          </div>
