...
const products = [
  {
    id: 1,
    name: "Eletrodo Direcional SenSight™",
    image: "/images/imgs-prods/neurofuncional-dbs/eletrodo-direcional-sensight.jpg",
    description: "Eletrodo direcional de próxima geração para estimulação cerebral profunda com precisão otimizada.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/002_DBS_Dor_Cronica_ELetrodoLancamento_SenSight.pdf" }
    ]
  },
  {
    id: 2,
    name: "Neuroestimulador Percept PC com BrainSense™",
    image: "/images/imgs-prods/neurofuncional-dbs/neuroestimulador-percept-pc.jpg",
    description: "Primeiro sistema DBS com telemetria neural para monitoramento cerebral em tempo real.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/004_DBS_Percept_Patient.pdf" }
    ]
  },
  {
    id: 3,
    name: "Serviço de Estereotaxia e Micro Registro",
    image: "/images/imgs-prods/neurofuncional-dbs/serviço-deestereotaxia-e-micro-registro.jpg",
    description: "Sistema completo para planejamento cirúrgico estereotáxico e registro eletrofisiológico.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/003_DBS_percept.pdf" }
    ]
  },
  {
    id: 4,
    name: "Terapia DBS Medtronic",
    image: "/images/imgs-prods/neurofuncional-dbs/terapia-dbs-medtronic.jpg",
    description: "Solução completa de estimulação cerebral profunda para tratamento de distúrbios de movimento.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/TERAPIA_DBS.pdf" }
    ]
  }
]
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            <div className="max-w-3xl">
              ...
              <p className="text-lg lg:text-xl text-white/90 leading-relaxed">
                Estimulação Cerebral Profunda de última geração. Sistemas Percept PC com 
                BrainSense™, eletrodos direcionais SenSight™ e suporte completo de estereotaxia 
                para tratamento de Parkinson, tremor essencial e distonia.
              </p>
            </div>
          </div>
        </section>
