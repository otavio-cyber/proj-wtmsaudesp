...
const products = [
  {
    id: 1,
    name: "Estimulação Medular Recarregável Intellis™",
    image: "/images/imgs-prods/neurofuncional-neuroestimulador-dor-cronica/estimulacao-medular-recarregavel-intellis.jpg",
    description: "Sistema de estimulação medular recarregável com tecnologia AdaptiveStim para alívio personalizado da dor.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/001_Neuroestimulador_SIntellis_BrochuraPacienteProspectivoDor_FY19.pdf" }
    ]
  },
  {
    id: 2,
    name: "Neuroestimulador Programável Vanta™",
    image: "/images/imgs-prods/neurofuncional-neuroestimulador-dor-cronica/neuroestimulador-programavel-vanta.jpg",
    description: "Sistema de estimulação medular com múltiplas opções de programação para tratamento da dor crônica.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/003_Neuroestimulador_Programavel_Vanta.pdf" }
    ]
  }
]

export default function NeuroestimuladorDorCronica() {
  return (
    <>
      <Header />
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            <div className="max-w-3xl">
              <h1 className="text-4xl lg:text-5xl font-bold mb-6 tracking-tight">
                Neuroestimulador Dor Crônica
              </h1>
              <p className="text-lg lg:text-xl text-white/90 leading-relaxed">
                Estimulação medular de última geração para tratamento de dor crônica refratária. 
                Sistemas Intellis™ e Vanta™ com tecnologia AdaptiveStim e programação 
                personalizada para alívio eficaz da dor.
              </p>
            </div>
          </div>
        </section>
