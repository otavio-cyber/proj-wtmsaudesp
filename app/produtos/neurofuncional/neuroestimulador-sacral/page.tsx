...
const products = [
  {
    id: 1,
    name: "InterStim II™",
    image: "/images/imgs-prods/neurofuncional-neuroestimulador-sacral/interstim-ii.jpg",
    description: "Sistema de neuromodulação sacral para tratamento de disfunções urinárias e intestinais.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/001_neuroestumulador_sacral_interstim2.pdf" }
    ]
  },
  {
    id: 2,
    name: "InterStim™ Micro",
    image: "/images/imgs-prods/neurofuncional-neuroestimulador-sacral/interstim-micro.jpg",
    description: "Menor sistema de neuromodulação sacral recarregável disponível no mercado.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/002_InterStim_Micro.pdf" }
    ]
  }
]

export default function NeuroestimuladorSacral() {
  return (
    <>
      <Header />
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            <div className="max-w-3xl">
              ...
              <p className="text-lg lg:text-xl text-white/90 leading-relaxed">
                Terapia de neuromodulação sacral para tratamento de incontinência urinária, 
                retenção urinária não obstrutiva e incontinência fecal. Sistemas InterStim™ 
                com tecnologia comprovada e resultados clínicos superiores.
              </p>
            </div>
          </div>
        </section>
