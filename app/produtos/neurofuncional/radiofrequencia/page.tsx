...
const products = [
  {
    id: 1,
    name: "Aparelho de Radiofrequência",
    image: "/images/imgs-prods/neurofuncional-radiofrequencia/aparelho-de-radio-frequencia.png",
    description: "Sistema de radiofrequência para tratamento intervencionista da dor com controle preciso de temperatura.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/radiofrequencia.pdf" }
    ]
  },
  {
    id: 2,
    name: "Cânulas de Bloqueio",
    image: "/images/imgs-prods/neurofuncional-radiofrequencia/canulas-de-bloqueio.jpg",
    description: "Cânulas especializadas para procedimentos de bloqueio nervoso e radiofrequência.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/Canulas.pdf" }
    ]
  }
]

export default function Radiofrequencia() {
  return (
    <>
      <Header />
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            <div className="max-w-3xl">
              ...
              <p className="text-lg lg:text-xl text-white/90 leading-relaxed">
                Tecnologia de radiofrequência para tratamento intervencionista da dor. 
                Sistemas completos incluindo aparelhos de RF e cânulas especializadas 
                para bloqueios nervosos e procedimentos percutâneos.
              </p>
            </div>
          </div>
        </section>
