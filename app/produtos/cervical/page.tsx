...
const products = [
  {
    id: 1,
    name: "Cage Cornerstone",
    image: "/images/imgs-prods/cervical/001cornerstone.png",
    description: "Sistema de cage cervical intersomático com design otimizado para fusão anterior.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/CORNESTONE.pdf" }
    ]
  },
  {
    id: 2,
    name: "Cage Divergence",
    image: "/images/imgs-prods/cervical/002divergence.png",
    description: "Cage cervical com geometria divergente para maior estabilidade e contato vertebral.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/Divergence.pdf" }
    ]
  },
  {
    id: 3,
    name: "Cervical Posterior Vertex",
    image: "/images/imgs-prods/cervical/003vertex.png",
    description: "Sistema de fixação posterior cervical com parafusos e hastes de alta resistência.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/vertex.pdf" }
    ]
  },
  {
    id: 4,
    name: "Placa Atlantis",
    image: "/images/imgs-prods/cervical/004atlantis.png",
    description: "Sistema de placa cervical anterior com travamento dinâmico e perfil baixo.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/atlantis.pdf" }
    ]
  },
  {
    id: 5,
    name: "Prótese de Disco Cervical Prestige",
    image: "/images/imgs-prods/cervical/005prestige.png",
    description: "Artroplastia de disco cervical preservando movimento e biomecânica natural.",
    pdfLinks: [
      { label: "Baixar PDF", url: "https://wtmsaude.com.br/dl-arquivos/Prestige.pdf" }
    ]
  }
]
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            <div className="max-w-3xl">
              ...
              <p className="text-lg lg:text-xl text-white/90 leading-relaxed">
                Soluções completas para cirurgia de coluna cervical. Cages, placas, 
                sistemas de fixação posterior e próteses de disco para procedimentos 
                anteriores e posteriores com tecnologia Medtronic.
              </p>
            </div>
          </div>
        </section>
